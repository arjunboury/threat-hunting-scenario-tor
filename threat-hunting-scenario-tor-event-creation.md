...
DeviceProcessEvents
| where ProcessCommandLine contains "tor-browser-windows-x86_64-portable-14.5.2.exe  /S"
...
## Created By:
- **Author Name**: Arjun Boury
- **Author Contact**: https://www.linkedin.com/in/arjunboury/
- **Date**: May 22, 2025
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `May 22, 2024`  | `Arjun Boury`   
